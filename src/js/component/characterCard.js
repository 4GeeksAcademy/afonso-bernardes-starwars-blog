...
export const CharacterCard = (props) => (
    <div className="container text-left px-0 me-3 mb-3">
        <div className="card bg-light">
            <img src={props.characterImage} className="card-img-top" alt="..."></img>
            <div className="card-body">
                ...
                <div className="container-fluid d-flex justify-content-between px-0">
                    ...
                    <a href="#" className="btn btn-outline-danger mt-3"><FontAwesomeIcon className="my-auto" icon={faHeart} /></a>
                </div>
            </div>
        </div>
    </div>
